...
from mudsling import pickler, extensibility


class MoneyPlugin(extensibility.Plugin):
...
pickler.register_external_type(Currency, lambda c: c.code, Currency)


@functools.total_ordering
class Money(PersistentSlots):
    """
